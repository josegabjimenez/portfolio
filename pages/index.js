  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Full-Stack Developer specializing in creating beautiful digital experiences. Bridging the gap between design and development."
        />
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
        ...
        <div
          ...
          className="glow-orb glow-primary w-[500px] h-[500px] -top-48 -right-48 animate-pulse-glow"
        />
        {/* White glow orb - left center */}
        <div
          ref={(el) => (orbsRef.current[1] = el)}
          className="glow-orb glow-white w-[300px] h-[300px] top-1/3 -left-32 animate-float"
        />
        {/* Small primary orb - bottom left */}
        <div
          ref={(el) => (orbsRef.current[2] = el)}
          className="glow-orb glow-primary w-[200px] h-[200px] bottom-48 left-1/4 animate-float-delayed"
        />
        {/* White orb - bottom right */}
        <div
          ref={(el) => (orbsRef.current[3] = el)}
          className="glow-orb glow-white w-[250px] h-[250px] bottom-20 right-1/4 opacity-20 animate-float"
        />
      </div>
      ...
      <section ref={heroRef} className="relative z-10 min-h-[calc(100vh-6rem)] flex items-center justify-center px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            Bridging the gap between beautiful design and powerful development. 
            I create digital experiences that look stunning and perform flawlessly.
          </p>
          ...
          <div ref={servicesRef} className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            {services.map((service) => (
              <div
                key={service.title}
                className="service-card glass-card px-6 py-4 flex items-center gap-3 w-full sm:w-auto"
              >
